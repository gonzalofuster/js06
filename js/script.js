...
function calculo() {
    ...
    <ul>
        <li> 1 cuotas de $ ${costo1.toFixed(2)}</li>
        <li> 2 cuotas de $ ${costo2.toFixed(2)}</li>
        <li> 3 cuotas de $ ${costo3.toFixed(2)}</li>
        <li> 4 cuotas de $ ${costo4.toFixed(2)}</li>   
        <li> 5 cuotas de $ ${costo5.toFixed(2)}</li>   
        <li> 6 cuotas de $ ${costo6.toFixed(2)}</li>
        <li> 7 cuotas de $ ${costo7.toFixed(2)}</li>   
        <li> 8 cuotas de $ ${costo8.toFixed(2)}</li>   
        <li> 9 cuotas de $ ${costo9.toFixed(2)}</li>   
        <li> 10 cuotas de $ ${costo10.toFixed(2)}</li>   
        <li> 11 cuotas de $ ${costo11.toFixed(2)}</li>   
        <li> 12 cuootas de $ ${costo12.toFixed(2)}</li>
    </ul>`
}